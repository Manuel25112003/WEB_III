...
<div class="pagina">
    ...
    <div class="encabezado">
        <div class="encabezado-titulo"><i class="bi bi-briefcase me-2"></i>Registrar Cargo</div>
        <div class="encabezado-sub">Añadir un nuevo cargo al sistema</div>
    </div>

    <form method="post" action="../controller/cargoRegistro.php">

        <div class="form-group">
            <label class="form-label" for="cargo"><i class="bi bi-tag me-1 text-secondary"></i> Nombre del Cargo</label>
            <input type="text" name="cargo" id="cargo" class="form-control" placeholder="Ej: Administrador, Vendedor..." required>
        </div>

        <div class="acciones">
            <button type="submit" name="registrarCargo" class="btn-guardar">
                <i class="bi bi-floppy-fill me-2"></i>Registrar Cargo
            </button>
            <a href="../controller/cargoLista.php" class="btn-volver">
    ...
    <div class="footer-creditos">
        <i class="bi bi-code-slash me-1"></i> Sistema de Gestión &copy; 2026
    </div>

...
<div class="pagina">
    ...
    <div class="encabezado">
        <div>
            <div class="encabezado-titulo"><i class="bi bi-people me-2"></i>Panel de Clientes</div>
            <div class="encabezado-sub">Lista de Clientes Activos</div>
        </div>
        <div style="display:flex; gap:.6rem; align-items:center; flex-wrap: wrap;">
            <a href="../controller/clienteRegistroCo.php" class="btn-nuevo">
                <i class="bi bi-person-plus-fill me-1"></i>Nuevo Cliente
            </a>
            <a href="../controller/clienteReporte.php" target="_blank" class="btn-reporte">
                <i class="bi bi-file-earmark-text me-1"></i>Reporte
            </a>
            <a href="../controller/clienteBusqueda.php" class="btn-buscar">
    ...
    <?php if (empty($resultado) || count($resultado) == 0): ?>
        <div class="vacio" style="text-align: center; padding: 4rem 2rem; background: #fff; border-radius: 12px; border: 1px dashed #cbd5e1;">
            ...
            <h4 style="color: #334155; font-weight: 700;">No existen registros</h4>
            <p style="color: #64748b;">Aún no hay clientes registrados en el sistema.</p>
            <a href="../controller/clienteRegistroCo.php" class="btn-nuevo mt-2"><i class="bi bi-plus-lg me-1"></i>Agregar el primero</a>
        </div>
    <?php else: ?>
        <div class="contador">Mostrando <?= count($resultado) ?> cliente<?= count($resultado) != 1 ? 's' : '' ?></div>
            ...
            <table class="tabla-clientes">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-weight:600; color: #0f172a;"><?= htmlspecialchars($reg['razonsocial']) ?></td>
                        <td class="td-acciones">
                            <a href="../controller/clienteModifica.php?cod=<?= $reg['id_cliente'] ?>" class="btn-editar">
                                <i class="bi bi-pencil-square me-1"></i>Modificar
                            </a>
                            <a href="../controller/clienteInactiva.php?cod=<?= $reg['id_cliente'] ?>" class="btn-eliminar"
                                onclick="return confirm('¿Seguro que deseas eliminar/inactivar al cliente: <?= htmlspecialchars(addslashes($reg['razonsocial'])) ?>?')">
